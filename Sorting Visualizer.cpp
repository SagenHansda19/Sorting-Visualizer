                ...
                if (e.type == SDL_QUIT) {
                    ...
                    case(SDLK_1):
                        ...
                        complete = false;
                        {
                            ...
                            cout << "\nSELECTION SORT COMPLETE. Time taken: " << duration.count() << " ms\n";
                        }
                        complete = true;
                        break;
                    case(SDLK_2):
                        ...
                        complete = false;
                        {
                            ...
                            auto duration = duration_cast<milliseconds>(end - start);
                            cout << "\nINSERTION SORT COMPLETE. Time taken: " << duration.count() << " ms\n";
                        }
                        complete = true;
                        break;
                    case(SDLK_3):
                        ...
                        complete = false;
                        {
                            ...
                            auto end = high_resolution_clock::now();
                            auto duration = duration_cast<milliseconds>(end - start);
                            cout << "\nBUBBLE SORT COMPLETE. Time taken: " << duration.count() << " ms\n";
                        }
                        complete = true;
                        break;
                    case(SDLK_4):
                        ...
                        complete = false;
                        {
                            ...
                            auto end = high_resolution_clock::now();
                            auto duration = duration_cast<milliseconds>(end - start);
                            cout << "\nMERGE SORT COMPLETE. Time taken: " << duration.count() << " ms\n";
                        }
                        complete = true;
                        break;
                    case(SDLK_5):
                        ...
                        complete = false;
                        {
                            ...
                            auto end = high_resolution_clock::now();
                            auto duration = duration_cast<milliseconds>(end - start);
                            cout << "\nQUICK SORT COMPLETE. Time taken: " << duration.count() << " ms\n";
                        }
                        complete = true;
                        break;
                    case(SDLK_6):
                        ...
                        complete = false;
                        {
                            ...
                            auto end = high_resolution_clock::now();
                            auto duration = duration_cast<milliseconds>(end - start);
                            cout << "\nHEAP SORT COMPLETE. Time taken: " << duration.count() << " ms\n";
                        }
                        complete = true;
                        break;
                    }
